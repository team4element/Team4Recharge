...
public class MidStartToRendPoints{
    ...
    public static final Pose2d finishIntakePose = new Pose2d(new Translation2d(240, 35), Rotation2d.fromDegrees(180+90));
    public static final Pose2d allignShootPose = new Pose2d(new Translation2d(190, -35), Rotation2d.fromDegrees(0));
    public static final Pose2d finalPose = new Pose2d(new Translation2d(105, -45), Rotation2d.fromDegrees(10));
